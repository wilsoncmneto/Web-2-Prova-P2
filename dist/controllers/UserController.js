...
const { normalizeText, normalizeEmail, sendValidationError, sanitizeUser, schemas, validateYupSchema, } = require('../utils/validation');
const router = Router();
...
router.put('/usuarios/:id', async (req, res) => {
    try {
        ...
        const updateData = {};
        if ('name' in req.body)
            updateData.name = normalizeText(req.body.name);
